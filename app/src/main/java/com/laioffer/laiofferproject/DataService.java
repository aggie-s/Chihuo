...
public class DataService {
    ...
    private static final String BASE_HOSTNAME = "192.168.1.102";
    ...
    public List<Restaurant> getNearbyRestaurants() {
        String[] request = {"GetRestaurantsNearby", "38.339637", "-122.701098"};
    ...
    private List<Restaurant> sendPostRequest(String[] request){
        try {
            ...
            JsonArrayRequest jsonRequest = new JsonArrayRequest(Request.Method.POST, url, payload, future, future);
        ...
        try {
            for (int i = 0; i < response.length(); i++) {
                ...
                if (business != null) {
                    ...
                    Bitmap thumbnail = getBitmapFromURL(imageUrl);
                    restaurants.add(new Restaurant(businessId, name, address, type, lat, lng, thumbnail));
                }
            }
            return restaurants;
